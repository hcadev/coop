	...
	<div class="col-xs-12 small" style="background-color: #fff; border-radius: 5px">
		...
		<div class="row">
			<div class="col-xs-12 text-center">
				<h5>Savings Accounts Status Report<br><small><?= $from.' to '.$to; ?></small></h5>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<table class="table table-bordered table-striped table-hover">
					<tr>
						<th class="text-center col-xs-4">Name</th>
						<th class="text-center col-xs-2">Deposits</th>
						<th class="text-center col-xs-2">Withdrawals</th>
					...
					<?php else: ?>
						<?php $total_deposits = $total_withdrawals = $total_interest = $total_service_charge = 0; ?>
						<?php foreach ($list AS $account): ?>
							<?php $total_deposits += $account['deposits']; ?>
							<?php $total_withdrawals += $account['withdrawals']; ?>
							...
							<tr>
								...
								<td class="text-right"><?= number_format($account['deposits'], 2, '.', ','); ?></td>
								<td class="text-right"><?= number_format($account['withdrawals'], 2, '.', ','); ?></td>
						...
						<tr>
							...
							<td class="text-right"><?= number_format($total_deposits, 2, '.', ','); ?></td>
							<td class="text-right"><?= number_format($total_withdrawals, 2, '.', ','); ?></td>
